...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyC7biPz58ylPbox9zfPH6Y5x0Qp3L2OiZE";
        ...
        client.get(String.format(VIDEO_URL, movie.getId()), new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                ...
                try {
                    ...
                    initializeYoutube(ytKey, movie.getRate());
    ...
    private void initializeYoutube(String ytKey, double rate) {
